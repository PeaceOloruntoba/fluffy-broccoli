...
export async function getSchoolAttendance(req: Request, res: Response) {
  try {
    ...
    return sendError(res, e instanceof Error ? e.message : 'list_school_attendance_failed', 400);
  }
}
...
export async function getBusAttendance(req: Request, res: Response) {
  try {
    ...
    return sendError(res, e instanceof Error ? e.message : 'list_bus_attendance_failed', 400);
  }
}
